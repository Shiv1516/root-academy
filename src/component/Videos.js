...
const Videos = () => {
  return (
    <section className="videoes ptb48 bg4">
        ...
        <div className="video-cards-box df fww">
          <div className="video flx33 mb24">
            <div className="video-section mlr12">
              ...
              <iframe
                ...
                src="https://www.youtube.com/embed/Ax-3jj3xaDA?si=ku8WBlrOmfSY0ep9"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                referrerpolicy="strict-origin-when-cross-origin"
          ...
          <div className="video flx33 mb24">
            <div className="video-section mlr12">
              <iframe
                className="video-box br16 transit2"
                src="https://www.youtube.com/embed/xBoD4lCePPo?si=l92YvTU3IsiLGSZR"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                referrerpolicy="strict-origin-when-cross-origin"
              ...
              {/* <iframe
                ...
                src="https://www.youtube.com/embed/s52OeQDrV7w?si=aMpLLj3oKQ_HXaaV"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                referrerpolicy="strict-origin-when-cross-origin"
              ...
              <div className="teacher-img  p16 df">
                ...
                <div className="video-tag-line pl16">
                  <h2 className="video-line fw6 lh24 mb12">
                    Income Method | National Income | Macro Economics | Class 12
                    | Part-2
                  </h2>
                  <p className="channel-name fs15 fw5">Ameesh Sir</p>
                </div>
